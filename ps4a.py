...
def updateHand(hand, word):
    ...
    returns: dictionary (string -> int)
    """
    # Cloned the hand, as to not make any alerations to the original variable
    newHand = hand.copy()
    for letter in word:
    ...
    while True:
        ...
        if userInput == '.':
            ...
            if isValidWord(userInput, hand, wordList):
                ...
                handTotal += wordScore
                print('"' + userInput + '"' + 'earned ' + str(wordScore) + 'points. Total: ' + str(handTotal) + ' points')
